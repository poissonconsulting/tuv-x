...
!
!> \file
!> This clo+hv->cl+o3p quantum yield module

!> The clo+hv->cl+o3p quantum yield type and related functions
module micm_clo_cl_o3p_quantum_yield_type
  ...
  private
  public :: clo_cl_o3p_quantum_yield_t

  !> Calculator for clo+hv->cl+o3p quantum yield
  type, extends(base_quantum_yield_t) :: clo_cl_o3p_quantum_yield_t
  contains
    !> Calculate the quantum yield
    procedure :: calculate => run
  end type clo_cl_o3p_quantum_yield_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function run( this, gridWareHouse, ProfileWareHouse ) result( quantum_yield )
    ...
    !> Arguments
    class(clo_cl_o3p_quantum_yield_t), intent(in) :: this
    !> The warehouses
...
end module micm_clo_cl_o3p_quantum_yield_type
