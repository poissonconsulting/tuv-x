...
!
program test_quantum_yield_tint

  use musica_mpi,                      only : musica_mpi_init,                &
                                              musica_mpi_finalize
  use tuvx_quantum_yield_tint

  implicit none

  call musica_mpi_init( )
  call test_quantum_yield_tint_t( )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine test_quantum_yield_tint_t( )
    ! Test functionality of the :f:type:`~tuvx_quantum_yield_tint/quantum_yield_tint_t`
    ! class.
    !
  ...
  end subroutine test_quantum_yield_tint_t

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

end program test_quantum_yield_tint
