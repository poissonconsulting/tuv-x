...
! Calculates the cross section for methyl nitrate
  ...
  private
  public :: cross_section_ch3ono2_ch3o_no2_t

  !> Calculator for ch3ono2-ch3o_no2 cross section
  type, extends(cross_section_t) :: cross_section_ch3ono2_ch3o_no2_t
  contains
    !> Calculate the cross section
    procedure :: calculate
  end type cross_section_ch3ono2_ch3o_no2_t

  !> Constructor
  interface cross_section_ch3ono2_ch3o_no2_t
    module procedure constructor
  end interface cross_section_ch3ono2_ch3o_no2_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( config, grid_warehouse, profile_warehouse )           &
    ...
    call assert_msg( 215631174,                                               &
                     config%validate( required_keys, optional_keys ),         &
                     "Bad configuration data format for "//                   &
                     "ch3ono2->ch3o+no2 cross section." )
    allocate ( cross_section_ch3ono2_ch3o_no2_t :: this )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function calculate( this, grid_warehouse, profile_warehouse, at_mid_point ) &
    ...
    character(len=*), parameter :: Iam =                                      &
        'ch3ono2->ch3o+no2 cross section run'
