  ...
  function quantum_yield_builder( config, grid_warehouse, profile_warehouse ) &
    ...
    select case( quantum_yield_type%to_char() )
      case( 'base quantum yield' )
        ...
        call base_constructor( quantum_yield, config, grid_warehouse, profile_warehouse )
      case( 'tint quantum yield' )
        quantum_yield => quantum_yield_tint_t( config, grid_warehouse, profile_warehouse )
      case( 'NO2 tint quantum yield' )
        quantum_yield => quantum_yield_no2_tint_t( config, grid_warehouse, profile_warehouse )
      case( 'O3+hv->O2+O(1D) quantum yield' )
        quantum_yield => quantum_yield_o3_o2_o1d_t( config, grid_warehouse, profile_warehouse )
      case( 'O3+hv->O2+O(3P) quantum yield' )
        quantum_yield => quantum_yield_o3_o2_o3p_t( config, grid_warehouse, profile_warehouse )
      case( 'HO2 quantum yield' )
        quantum_yield => quantum_yield_ho2_oh_o_t( config, grid_warehouse, profile_warehouse )
      case( 'NO3-_(aq)+hv->NO2(aq)+O- quantum yield' )
        quantum_yield => quantum_yield_no3m_aq_t( config, grid_warehouse, profile_warehouse )
      case( 'CH2O quantum yield' )
        quantum_yield => quantum_yield_ch2o_h2_co_t( config, grid_warehouse, profile_warehouse )
      case( 'CH3CHO+hv->CH3+HCO quantum yield' )
        quantum_yield => quantum_yield_ch3cho_ch3_hco_t( config, grid_warehouse, profile_warehouse )
      case( 'C2H5CHO quantum yield' )
        quantum_yield => quantum_yield_c2h5cho_c2h5_hco_t( config, grid_warehouse, profile_warehouse )
      case( 'CH2CHCHO+hv->Products quantum yield' )
        quantum_yield => quantum_yield_ch2chcho_t( config, grid_warehouse, profile_warehouse )
      case( 'MVK+hv->Products quantum yield' )
        quantum_yield => quantum_yield_mvk_t( config, grid_warehouse, profile_warehouse )
      case( 'CH3COCH3+hv->CH3CO+CH3 quantum yield' )
        quantum_yield => quantum_yield_ch3coch3_ch3co_ch3_t( config, grid_warehouse, profile_warehouse )
      case( 'CH3COCH2CH3+hv->CH3CO+CH2CH3 quantum yield' )
        quantum_yield => quantum_yield_ch3coch2ch3_t( config, grid_warehouse, profile_warehouse )
      case( 'CH3COCHO+hv->CH3CO+HCO quantum yield' )
        quantum_yield => quantum_yield_ch3cocho_ch3co_hco_t( config, grid_warehouse, profile_warehouse )
      case( 'ClO+hv->Cl+O(1D) quantum yield' )
        quantum_yield => quantum_yield_clo_cl_o1d_t( config, grid_warehouse, profile_warehouse )
      case( 'ClO+hv->Cl+O(3P) quantum yield' )
        quantum_yield => quantum_yield_clo_cl_o3p_t( config, grid_warehouse, profile_warehouse )
      case( 'ClONO2+hv->Cl+NO3 quantum yield' )
        quantum_yield => quantum_yield_clono2_cl_no3_t( config, grid_warehouse, profile_warehouse )
      case( 'ClONO2+hv->ClO+NO2 quantum yield' )
        quantum_yield => quantum_yield_clono2_clo_no2_t( config, grid_warehouse, profile_warehouse )
      case default
