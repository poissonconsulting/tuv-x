...
! Calculates the cross section for nitroxy ethanol
  ...
  private
  public :: cross_section_nitroxy_ethanol_t

  !> Calculator for nitroxy_ethanol cross section
  type, extends(cross_section_t) :: cross_section_nitroxy_ethanol_t
  contains
    !> Calculate the cross section
    procedure :: calculate
  end type cross_section_nitroxy_ethanol_t

  !> Constructor
  interface cross_section_nitroxy_ethanol_t
    module procedure constructor
  end interface cross_section_nitroxy_ethanol_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( config, grid_warehouse, profile_warehouse )           &
    ...
    call assert_msg( 258467424,                                               &
                     config%validate( required_keys, optional_keys ),         &
                     "Bad configuration data format for "//                   &
                     "nitroxy_ethanol cross section." )
    allocate( cross_section_nitroxy_ethanol_t :: this )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function calculate( this, grid_warehouse, profile_warehouse, at_mid_point ) &
    ...
    class(cross_section_nitroxy_ethanol_t), intent(in)    :: this ! A :f:type:`~tuvx_cross_section_nitroxy_ethanol/cross_section_nitroxy_ethanol_t`
    type(grid_warehouse_t),    intent(inout) :: grid_warehouse ! A :f:type:`~tuvx_grid_warehouse/grid_warehouse_t`
    type(profile_warehouse_t), intent(inout) :: profile_warehouse ! A :f:type:`~tuvx_profile_warehouse/profile_warehouse_t`
    ...
    character(len=*), parameter :: Iam =                                      &
        'nitroxy_ethanol cross section calculate'
