...
module tuvx_spectral_weight_standard_human_erythema
  ...
  private
  public :: spectral_weight_standard_human_erythema_t

  type, extends(spectral_weight_t) ::                                         &
      spectral_weight_standard_human_erythema_t
    ! Calculator for standard human erythema spectral weight
  contains
    procedure :: calculate => run
  end type spectral_weight_standard_human_erythema_t

  interface spectral_weight_standard_human_erythema_t
    module procedure constructor
  end interface spectral_weight_standard_human_erythema_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( config, grid_warehouse, profile_warehouse )           &
      result ( this )
    ! Initialize the standard human erthema spectral weight
...
end module tuvx_spectral_weight_standard_human_erythema
