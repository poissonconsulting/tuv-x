...
program test_cross_section
  ...
  call test_cross_section_nitroxy_ethanol_t( )

contains

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  subroutine test_cross_section_nitroxy_ethanol_t( )
    ...
    call config%from_file( "test/data/cross_section.nitroxy.config.json" )
  ...
  end subroutine test_cross_section_nitroxy_ethanol_t
