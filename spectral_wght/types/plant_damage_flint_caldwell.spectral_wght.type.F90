...
module micm_plant_damage_flint_caldwell_spectral_wght_type
  ...
  private
  public :: plant_damage_flint_caldwell_spectral_wght_t

  !> Calculator for plant_damage_flint_caldwell_spectral_wght
  type, extends(base_spectral_wght_t) :: plant_damage_flint_caldwell_spectral_wght_t
  contains
    !> Calculate the spectral weight
    procedure :: calculate => run
  end type plant_damage_flint_caldwell_spectral_wght_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function run( this, environment ) result( spectral_wght )
    ...
    !> plant_damage_flint_caldwell type
    class(plant_damage_flint_caldwell_spectral_wght_t), intent(in) :: this
    ...
    character(len=*), parameter :: Iam = 'plant_damage_flint_caldwell calculate: '
    ...
    where( spectral_wght < 0.0_musica_dk .or. this%mdl_lambda_center > 366._musica_dk )
...
end module micm_plant_damage_flint_caldwell_spectral_wght_type
