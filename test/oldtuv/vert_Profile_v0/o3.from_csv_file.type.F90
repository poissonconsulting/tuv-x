...
!
!from csv file type
module micm_o3_from_csv_file_vert_Profile
  ...
  type, extends(abs_vert_Profile_t) :: o3fromCsvFile_t
  contains
    !> Initialize grid
...
contains
  ...
  subroutine initialize( this, profile_config, gridWareHouse )
    ...
    character(len=*), parameter :: Iam = 'O3_from_csv_file vert_Profile initialize: '
...
end module micm_o3_from_csv_file_vert_Profile
