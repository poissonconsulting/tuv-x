...
module tuvx_spectral_wght_uv_index
  ...
  private
  public :: spectral_wght_uv_index_t

  !> Calculator for uv_index_spectral_wght
  type, extends(spectral_wght_t) :: spectral_wght_uv_index_t
  contains
    !> Calculate the spectral wght
    procedure :: calculate => run
  end type spectral_wght_uv_index_t

  !> Constructor
  interface spectral_wght_uv_index_t
    module procedure constructor
  end interface spectral_wght_uv_index_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( config, grid_warehouse, profile_warehouse )           &
    ...
    !> Local variables
    character(len=*), parameter :: Iam = 'uv index constructor: '
    ...
    allocate (spectral_wght_uv_index_t :: this )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function run( this, grid_warehouse, profile_warehouse ) result( spectral_wght )
    ...
    !> Arguments
    class(spectral_wght_uv_index_t), intent(in) :: this
    !> Warehouses
    type(grid_warehouse_t), intent(inout)              :: grid_warehouse
    type(profile_warehouse_t), intent(inout)           :: profile_warehouse
    ...
    !> Local variables
    character(len=*), parameter :: Iam = 'uv index calculate: '
    ...
    spectral_wght = 40._dk * sw_fery( lambdaGrid%mid_ )
...
end module tuvx_spectral_wght_uv_index
