...
!> The plant damage type and related functions
module tuvx_spectral_wght_plant_damage
  ...
  private
  public :: spectral_wght_plant_damage_t

  !> Calculator for plant damage spectral_wght
  type, extends(spectral_wght_t) :: spectral_wght_plant_damage_t
  contains
    !> Calculate the spectral wght
    procedure :: calculate => run
  end type spectral_wght_plant_damage_t

  !> Constructor
  interface spectral_wght_plant_damage_t
    module procedure constructor
  end interface spectral_wght_plant_damage_t
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function constructor( config, grid_warehouse, profile_warehouse )           &
    ...
    !> Local variables
    character(len=*), parameter :: Iam = 'plant damage constructor: '
    ...
    allocate (spectral_wght_plant_damage_t :: this )
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function run( this, grid_warehouse, profile_warehouse ) result( spectral_wght )
    ...
    !> Arguments
    class(spectral_wght_plant_damage_t), intent(in) :: this
    !> Warehouses
    type(grid_warehouse_t), intent(inout)              :: grid_warehouse
    type(profile_warehouse_t), intent(inout)           :: profile_warehouse
    ...
    !> Local variables
    character(len=*), parameter :: Iam = 'plant damage calculate: '
...
end module tuvx_spectral_wght_plant_damage
